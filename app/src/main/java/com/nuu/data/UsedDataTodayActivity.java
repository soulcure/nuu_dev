...
public class UsedDataTodayActivity extends BaseActivity implements View.OnClickListener {

    public static final String TAG = UsedDataTodayActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.used_data_today_activity);
        initView();
    ...
    private void initView() {
        ...
        btn_begin_data = (Button) findViewById(R.id.btn_begin_data);
        btn_begin_data.setOnClickListener(this);

        btn_end_data = (Button) findViewById(R.id.btn_end_data);
        btn_end_data.setOnClickListener(this);
        ...
        mAdapter = new UsedDataAdapter(this);
        ...
        OkHttpConnector.httpPost(url, params, new IPostListener() {
            ...
            public void httpReqResult(String response) {
                ...
                if (rsp != null && rsp.getErr_code() == 0) {
                    ...
                    tv_date.setText(rsp.getDate());
                    tv_used.setText(AppUtils.bytes2mb(rsp.getUsed_data()));
                    tv_total.setText(AppUtils.bytes2mb(rsp.getTotal_data()));

                    mAdapter.setList(rsp.getUsed_dtl());
